/*
  Embedded QR encoder for the share button.
  QRCode for JavaScript, Copyright (c) 2009 Kazuhiko Arase, MIT License.
  This embedded copy comes from npm's qrcode-terminal vendored QRCode implementation.
  It has been wrapped here with a tiny in-page CommonJS loader; QR algorithm source is otherwise unchanged.
*/
(function (global) {
  const modules = {
